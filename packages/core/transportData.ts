import { _support, validateOption, logger, isBrowserEnv, isWxMiniEnv, variableTypeDetection, Queue, isEmpty } from '../utils/index'
import { createErrorId } from './errorId'
import { SDK_NAME, SDK_VERSION } from '../shared/index'
import { breadcrumb } from './breadcrumb'
import { AuthInfo, TransportDataType, EMethods, InitOptions, isReportDataType, DeviceInfo, FinalReportType } from '../types/index'
/**
